...
wget -qO- https://raw.githubusercontent.com/Cyber-ssh/Checkusers/main/chall.sh -O /bin/chall > /dev/null 2>&1
wget -qO- https://raw.githubusercontent.com/Cyber-ssh/Checkusers/main/checkgestor.sh -O /bin/checkgestor > /dev/null 2>&1
wget -qO- https://raw.githubusercontent.com/Cyber-ssh/Checkusers/main/checkgestor.py -O /usr/lib/checkgestor/checkgestor.py > /dev/null 2>&1
...
echo -e 'By: @cybercoari' > /etc/licencec/telegram
sleep 2
}
install() {
