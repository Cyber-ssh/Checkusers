...
wget -qO- https://raw.githubusercontent.com/Cyber-ssh/Checkuser/main/chall.sh -O /bin/chall > /dev/null 2>&1
wget -qO- https://raw.githubusercontent.com/Cyber-ssh/Checkuser/main/checkgestor.sh -O /bin/checkgestor > /dev/null 2>&1
wget -qO- https://raw.githubusercontent.com/Cyber-ssh/Checkuser/main/checkgestor.py -O /usr/lib/checkgestor/checkgestor.py > /dev/null 2>&1
...
echo -e 'By: @Cyberssh23' > /etc/licencec/telegram
sleep 2
}
install() {
...
echo -e "\E[44;1;37mVERSÃO 1.0             By @Cyberssh23\E[0m"
echo ""
...
echo ""
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m \033[0m"
echo ""
